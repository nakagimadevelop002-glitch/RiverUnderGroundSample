...
namespace KWS
{
    internal static class KWS_EditorUtils
    {
        ...
        public static Color ColorFieldHUE(string text, string description, Color value, bool shoeEyedropper, bool showAlpha, bool hdr, string helpVideoName, bool useHelpButton = true)
        {
            EditorGUILayout.BeginHorizontal();
            var newValue = EditorGUILayout.ColorField(new GUIContent(text, description), value, shoeEyedropper, showAlpha, hdr);
        ...
        internal static void KWS_Tab(ref bool isVisibleTab, bool useHelpBox, bool useExpertButton, ref bool isExpertMode, string tabName, WaterTabSettings settings, WaterSystem.WaterSettingsCategory waterTab)
        {
            ...
            if (isVisibleTab)
            {
                ...
                GUILayout.Space(5);
                if (useExpertButton) isExpertMode = GUILayout.Toggle(isExpertMode, isExpertMode ? "Expert Settings -" : "Expert Settings +", ExpertButtonStyle, GUILayout.Height(18));
        ...
        internal static void KWS_Tab(bool isWaterActive, ref bool isToogleSelected, ref bool isVisibleTab, bool useExpertButton, ref bool isExpertMode, string tabName, WaterTabSettings settings, WaterSystem.WaterSettingsCategory waterTab)
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.BeginHorizontal(ButtonStyle);
        ...
        public static void SaveRenderTexture(this RenderTexture rt, string pathToFileWithoutExtension)
        {
#if UNITY_EDITOR
            if (rt == null) return;
        ...
        public static void SaveRenderTextureDepth32(this RenderTexture rt, string pathToFileWithoutExtension)
        {
#if UNITY_EDITOR
            if (rt == null) return;
            var currentRT = RenderTexture.active;
        ...
        internal static void KWS2_Tab(ref bool isVisibleTab, bool useHelpBox, bool useExpertButton, ref bool isExpertMode, string tabName, WaterTabSettings settings, WaterSystem.WaterSettingsCategory waterTab, float foldoutSpace = 0)
        {
        ...
        internal static void KWS2_TabWithEnabledToogle(ref bool isToogleSelected, ref bool isVisibleTab, bool useExpertButton, ref bool isExpertMode, string tabName, WaterTabSettings settings, WaterSystem.WaterSettingsCategory waterTab, float foldoutSpace = 0)
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUILayout.BeginHorizontal(ButtonStyle);
